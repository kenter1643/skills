...
**Zhuliren destila la forma de pensar de cualquier persona. Haz que Musk, Naval, Munger y Feynman trabajen para ti.**
...
Solo ingresa un nombre: Zhuliren maneja la investigación, extracción y validación automáticamente.

[Ejemplos](#ejemplos) · [Instalación](#instalación) · [Qué destila Zhuliren](#qué-destila-nuwa) · [Cómo funciona](#cómo-funciona)
...
[<img src="bloome-advisors.jpg" alt="Bloome - Conviértelos en tu equipo de asesores" width="720">](https://www.bloome.im/?utm_source=huashu-leon-202605&utm_medium=github&utm_campaign=zhuliren-skill)

¿Quieres hablar de producto con Jobs o Allen Zhang cuando quieras? ¿De inversiones con Munger?

[Bloome](https://www.bloome.im/?utm_source=huashu-leon-202605&utm_medium=github&utm_campaign=zhuliren-skill) —— Conviértelos en tu equipo de asesores. Humanos y varios agentes colaborando en una misma conversación. [www.bloome.im](https://www.bloome.im/?utm_source=huashu-leon-202605&utm_medium=github&utm_campaign=zhuliren-skill)

---

## Instalación

Zhuliren está construido sobre el estándar abierto [Agent Skills](https://agentskills.io). Funciona en cualquier runtime de agente IA compatible con skills.
...
```
Instala este skill: https://github.com/kenter1643/skills/tree/main/zhuliren-skill
```
...
cp -R skills/zhuliren-skill <ruta-de-arriba>
```
...
Incluso sin un runtime con skills automáticos, puedes pegar cualquier `SKILL.md` en tu contexto — Zhuliren es markdown plano + YAML frontmatter.
...
## Qué destila Zhuliren

Destilar las mejores mentes en cualquier campo requiere extraer algo más profundo que los hábitos de trabajo diarios. Zhuliren extrae seis capas:
...
Los hábitos de trabajo se pueden transmitir con documentos de proceso. Pero lo que hace que Munger y Musk lleguen a conclusiones diferentes sobre el mismo problema son sus marcos cognitivos. Zhuliren extrae el sistema operativo cognitivo.
...
Ingresa un nombre y Zhuliren hace cuatro cosas:
...
Zhuliren no copia personas. Extrae sistemas operativos cognitivos.

**Zhuliren (主理人)**, la diosa en la mitología china que creó humanos de arcilla. Aquí la arcilla es información pública, y lo que se crea no es una persona — es un espejo.

---

## Sobre el autor

Huashu / Huasheng, AI Native Coder, desarrollador independiente. Todos los productos están construidos con código escrito por IA ([Kitten Fill Light](https://apps.apple.com/app/id6738028637) llegó al #1 en el chart de pago de App Store China). Ejecutando 40+ skills personalizados en Claude Code. Zhuliren es el skill que crea skills.
...
**Zhuliren** destila cómo una persona piensa.<br><br>
*La próxima persona que quieras destilar no tiene por qué ser un colega.*
