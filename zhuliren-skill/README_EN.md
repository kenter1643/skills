...
**Zhuliren distills the thinking of anyone — let Musk, Naval, Munger, and Feynman work for you.**
...
Just input a name — Zhuliren handles research, extraction, and validation automatically.

[Examples](#examples) · [Install](#install) · [What Zhuliren Distills](#what-nuwa-distills) · [How It Works](#how-it-works)
...
[<img src="bloome-advisors.jpg" alt="Bloome - Make them your brain trust" width="720">](https://www.bloome.im/?utm_source=huashu-leon-202605&utm_medium=github&utm_campaign=zhuliren-skill)

Want to talk product with Jobs and Allen Zhang anytime? Investing with Munger?

[Bloome](https://www.bloome.im/?utm_source=huashu-leon-202605&utm_medium=github&utm_campaign=zhuliren-skill) — Make them your brain trust. Humans and multiple agents collaborating in a single conversation. [www.bloome.im](https://www.bloome.im/?utm_source=huashu-leon-202605&utm_medium=github&utm_campaign=zhuliren-skill)

---

## Install

Zhuliren is built on the open [Agent Skills](https://agentskills.io) standard. It works in any skills-compatible AI agent runtime.
...
```
Install this skill for me: https://github.com/kenter1643/skills/tree/main/zhuliren-skill
```
...
cp -R skills/zhuliren-skill <path-above>
```
...
Even without a skills-aware runtime, you can paste any `SKILL.md` into your prompt context — Zhuliren is plain markdown + YAML frontmatter.
...
## What Zhuliren Distills

Distilling the best minds in any field requires extracting something deeper than daily work habits. Zhuliren extracts six layers:
...
Work habits can be conveyed through process docs. But what makes Munger and Musk reach different conclusions about the same problem is their cognitive frameworks. Zhuliren extracts the cognitive operating system.
...
Input a name, and Zhuliren does four things:
...
Zhuliren doesn't copy people. It extracts cognitive operating systems.

**Zhuliren (主理人)**, the goddess in Chinese mythology who created humans from clay. Here the clay is public information, and what's created is not a person — it's a mirror.

---

## About the Author

Huashu / Huasheng, AI Native Coder, indie developer. All products are built by AI-written code ([Kitten Fill Light](https://apps.apple.com/app/id6738028637) reached #1 on China App Store paid chart). Running 40+ custom skills in Claude Code. Zhuliren is the skill that makes skills.
...
**Zhuliren** distills how a person thinks.<br><br>
*The next person you want to distill doesn't have to be a colleague.*
